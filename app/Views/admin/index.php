    ...
    <div class="container-xl">
        <div class="row row-deck row-cards">
            ...
            <div class="col-lg-6">
                ...
                <div class="card-table table-responsive">
                    ...
                    <tbody>
                        <tr>
                        <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url(./admin/static/avatars/000m.jpg)"></span>
                        </td>
                        ...
                        <tr>
                        <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url(./admin/static/avatars/002m.jpg)"></span>
                        </td>
                        <td class="td-truncate">
                            <div class="text-truncate">
                        ...
                        <tr>
                        <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url(./admin/static/avatars/003m.jpg)"></span>
                        </td>
                        <td class="td-truncate">
                            <div class="text-truncate">
                        ...
                        <tr>
                        <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url(./admin/static/avatars/000f.jpg)"></span>
                        </td>
                        <td class="td-truncate">
                            <div class="text-truncate">
                        ...
                        <tr>
                        <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url(./admin/static/avatars/001f.jpg)"></span>
                        </td>
                        <td class="td-truncate">
                            <div class="text-truncate">
            ...
            <div class="col-md-8">
                ...
                <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/002m.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/003m.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/000f.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/001f.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/002f.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/003f.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/006m.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/004f.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/007m.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/009m.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/010m.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/005f.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
                    ...
                    <div>
                        <div class="row">
                        <div class="col-auto">
                            <span class="avatar" style="background-image: url(./admin/static/avatars/006f.jpg)"></span>
                        </div>
                        <div class="col">
                            <div class="text-truncate">
            ...
            <div class="col-md-6 col-lg-4">
                <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener" style="background-image: url(./admin/static/sponsor-banner-homepage.svg)" aria-label="Sponsor Tabler!">
